...
public class UrutkanKoperasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = Config.getSharedPreferences(this)+Config.Fsortir;
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),CariKoperasi.class);
...
//                            Log.d("resul",response);
                            ...
                            myAdapter = new AdapterSortir(UrutkanKoperasi.this,lstSortir);
//                            myrv.setLayoutManager(manager);

                            final LinearLayoutManager llm = new LinearLayoutManager(UrutkanKoperasi.this);
                            llm.setOrientation(LinearLayoutManager.VERTICAL);
                            myrv.setLayoutManager(llm);
                            myrv.addItemDecoration(new DividerItemDecoration(UrutkanKoperasi.this,1));
...
//                        Toast.makeText(UrutkanKoperasi.this,"Terjadi kesalahan pada saat melakukan permintaan data", Toast.LENGTH_LONG).show();
...
//        snackBarView.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
            ...
            public Map getHeaders() throws AuthFailureError {
                ...
                headers.put("lat", Config.getLatNow(getApplicationContext(),UrutkanKoperasi.this));
                headers.put("long", Config.getLongNow(getApplicationContext(),UrutkanKoperasi.this));
                return headers;
            }
        };
