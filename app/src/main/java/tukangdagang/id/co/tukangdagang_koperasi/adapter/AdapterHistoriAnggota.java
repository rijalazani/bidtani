...
public class AdapterHistoriAnggota extends RecyclerView.Adapter<AdapterHistoriAnggota.MyViewHolder> {

    private Context mContext ;
    private List<ModelHistoriAnggota> mData ;
    ArrayList<ModelHistoriAnggota> arrayList;
    private boolean loggedIn = false;

    public AdapterHistoriAnggota(Context mContext, List<ModelHistoriAnggota> mData) {
        this.mContext = mContext;
        this.mData = mData;
        this.arrayList = new ArrayList<ModelHistoriAnggota>();
        this.arrayList.addAll(mData);
    }

    @Override
    public AdapterHistoriAnggota.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view ;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.row_histori_anggota,parent,false);
        return new AdapterHistoriAnggota.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AdapterHistoriAnggota.MyViewHolder holder, final int position) {
...
//            }
//        });
        holder.status_pengajuan.setText(mData.get(position).getPendaftaran_deskripsi());
