 ...
 */
public class DiterimaPinjaman extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    private RecyclerView myrv;
    private ShimmerFrameLayout mShimmerViewContainer;
    private List<ModelProsesPinjaman> listUnitList = new ArrayList<>();
    private AdapterDiterimaPinjaman listAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_diterima_pinjaman, container, false);
        ...
        coordinatorLayout = (CoordinatorLayout) rootview.findViewById(R.id.layoutTerimaPinjaman);
        ...
        try{
            ...
            listAdapter = new AdapterDiterimaPinjaman(getActivity(), listUnitList);
    ...
    private StringRequest getDataFromServer() {
        ...
        //Json request begins
        final StringRequest jsonArrayRequest = new StringRequest(pListURL+page+diterima,
