...
import tukangdagang.id.co.tukangdagang_koperasi.adapter.AdapterDiterimaAnggota;
import tukangdagang.id.co.tukangdagang_koperasi.adapter.AdapterDitolakAnggota;
 ...
 */
public class DitolakAnggota extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    private RecyclerView myrv;
    private ShimmerFrameLayout mShimmerViewContainer;
    private List<ModelProsesAnggota> listUnitList = new ArrayList<>();
    private AdapterDitolakAnggota listAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_ditolak_anggota, container, false);
        ...
        coordinatorLayout = (CoordinatorLayout) rootview.findViewById(R.id.layoutTolakAnggota);
        ...
        try{
            ...
            listAdapter = new AdapterDitolakAnggota(getActivity(), listUnitList);
