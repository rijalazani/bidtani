...
import tukangdagang.id.co.tukangdagang_koperasi.adapter.AdapterDiterimaPinjaman;
import tukangdagang.id.co.tukangdagang_koperasi.adapter.AdapterDitolakPinjaman;
import tukangdagang.id.co.tukangdagang_koperasi.adapter.AdapterProsesPinjaman;
...
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.diterima;
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.ditolak;
 ...
 */
public class DitolakPinjaman extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    private RecyclerView myrv;
    private ShimmerFrameLayout mShimmerViewContainer;
    private List<ModelProsesPinjaman> listUnitList = new ArrayList<>();
    private AdapterDitolakPinjaman listAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_ditolak_pinjaman, container, false);
        ...
        coordinatorLayout = (CoordinatorLayout) rootview.findViewById(R.id.layoutTolakPinjaman);

        btnDirect = (Button) rootview.findViewById(R.id.btn_derect_Pinjaman);

        pListURL = Config.getSharedPreferences(getActivity()) + Config.FlistPinjaman;
        ...
        try{
            ...
            listAdapter = new AdapterDitolakPinjaman(getActivity(), listUnitList);
    ...
    private StringRequest getDataFromServer() {
        ...
        //Json request begins
        final StringRequest jsonArrayRequest = new StringRequest(pListURL+page+ditolak,
    ...
    private void parseData(JSONArray response) {
        ...
        for(int i =0; i< response.length(); i++){
            ...
            try{
                ...
                ModelProsesPinjaman modelpinjam = gson.fromJson(jsonObject.toString(), ModelProsesPinjaman.class);
                progressBarLoading.setVisibility(GONE);
                listUnitList.add(modelpinjam);
