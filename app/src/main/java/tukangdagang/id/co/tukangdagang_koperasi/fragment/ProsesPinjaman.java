 ...
 */
public class ProsesPinjaman extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    private RecyclerView myrv;
    private ShimmerFrameLayout mShimmerViewContainer;
    private List<ModelProsesPinjaman> listUnitList = new ArrayList<>();
    private AdapterProsesPinjaman listAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_proses_pinjaman, container, false);
        ...
        try{
            ...
            listAdapter = new AdapterProsesPinjaman(getActivity(), listUnitList);
