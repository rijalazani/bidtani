...
public class WebPengajuanAnggota extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(WebPengajuanAnggota.this);
        settings();
        load_website();
    }
