...
public class WebPengajuanPinjaman extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ndetail = intent.getExtras().getString("detail");
        view = (WebView) this.findViewById(R.id.webview);
        loading = findViewById(R.id.progress);
        assert view != null;
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swiperefresh);
        swipeRefreshLayout.setOnRefreshListener(WebPengajuanPinjaman.this);
        settings();
        load_website();
    }
