...
public class WebRincianKoperasi extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(WebRincianKoperasi.this);
        settings();
        load_website();
    }
