...
public class DiterimaAnggota extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_diterima_anggota, container, false);
        ...
        coordinatorLayout = (CoordinatorLayout) rootview.findViewById(R.id.layoutTerimaAnggota);
        ...
        try{
            ...
            listAdapter = new AdapterDiterimaAnggota(getActivity(), listUnitList);
...
//                                }
                                Log.d("responku",response.toString());
