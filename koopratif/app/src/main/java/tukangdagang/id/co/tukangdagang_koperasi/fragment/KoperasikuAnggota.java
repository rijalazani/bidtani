 ...
 */
public class KoperasikuAnggota extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview = inflater.inflate(R.layout.fragment_koperasiku_anggota, container, false);
        swipeRefreshLayout = (SwipeRefreshLayout) rootview.findViewById(R.id.swiperefresh);
        swipeRefreshLayout.setOnRefreshListener(this);

        mShimmerViewContainer = rootview.findViewById(R.id.shimmer_view_container);
        myrv = rootview.findViewById(R.id.listKoprasi);
...
//        Toast.makeText(getApplicationContext(),pListURL+page+sudah_anggota,Toast.LENGTH_SHORT).show();
        ...
        final StringRequest jsonArrayRequest = new StringRequest(pListURL+page+sudah_anggota,
