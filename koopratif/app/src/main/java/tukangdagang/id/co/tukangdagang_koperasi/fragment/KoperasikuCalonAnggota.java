...
import tukangdagang.id.co.tukangdagang_koperasi.adapter.AdapterKoperasiku;
...
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.FKoperasiku;
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.PROFILE_ID;
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.bukan_anggota;
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.n_AccessToken;
import static tukangdagang.id.co.tukangdagang_koperasi.app.Config.sudah_anggota;


/**
 * A simple {@link Fragment} subclass.
 */
public class KoperasikuCalonAnggota extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    private RecyclerView myrv;
    private ShimmerFrameLayout mShimmerViewContainer;
    private List<ModelPinjamanCepatKoperasiku> listUnitList = new ArrayList<>();
    private AdapterKoperasiku listAdapter;
    ...
    private String url = Config.URL+ FKoperasiku;

    public KoperasikuCalonAnggota() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_koperasiku_calon_anggota, container, false);
        // Inflate the layout for this fragment
        swipeRefreshLayout = (SwipeRefreshLayout) rootview.findViewById(R.id.swiperefresh);
        swipeRefreshLayout.setOnRefreshListener(this);

        mShimmerViewContainer = rootview.findViewById(R.id.shimmer_view_container);
        myrv = rootview.findViewById(R.id.listKoprasiCalon);
        nodata = (LinearLayout) rootview.findViewById(R.id.nodata);
        coordinatorLayout = (CoordinatorLayout) rootview.findViewById(R.id.layoutProsesPinjaman);

        btnDirect = (Button) rootview.findViewById(R.id.btn_derect_Pinjaman);

        pListURL = Config.getSharedPreferences(getActivity()) + FKoperasiku;
        ...
        try{
            ...
            listAdapter = new AdapterKoperasiku(getActivity(), listUnitList);
    ...
    private StringRequest getDataFromServer() {
        Log.d("soisoi",pListURL+page+sudah_anggota);
        //good practice to put a loading progress here
        mShimmerViewContainer.startShimmerAnimation();
        nodata.setVisibility(GONE);
//        Toast.makeText(getApplicationContext(),pListURL+page+sudah_anggota,Toast.LENGTH_SHORT).show();
        Log.d("soisoi",pListURL+page+sudah_anggota);
        //Json request begins

        final StringRequest jsonArrayRequest = new StringRequest(pListURL+page+bukan_anggota,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Log.d("soisoi", String.valueOf(koperasiArray.length()));
//
    ...
    private void parseData(JSONArray response) {
        ...
        for(int i =0; i< response.length(); i++){
            ...
            try{
                ...
                ModelPinjamanCepatKoperasiku modelanggota = gson.fromJson(jsonObject.toString(), ModelPinjamanCepatKoperasiku.class);
                progressBarLoading.setVisibility(GONE);
